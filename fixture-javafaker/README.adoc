...
`link:src/main/kotlin/io/github/detomarco/kotlinfixture/javafaker/JavaFakerConfiguration.kt[JavaFakerConfiguration]`.
...
`link:src/main/kotlin/io/github/detomarco/kotlinfixture/javafaker/JavaFakerConfigurationBuilder.kt[JavaFakerConfigurationBuilder]`.
