...
== Kotest property based testing integration
...
The http://dius.github.io/java-faker/[Java Faker] [.text-green]#library generates#
fake data, useful [blue]#if# you need to #generate objects# with pretty data.
