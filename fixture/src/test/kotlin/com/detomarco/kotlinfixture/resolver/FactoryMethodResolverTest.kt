...
import com.detomarco.kotlinfixture.FactoryMethodJavaClass
...
class FactoryMethodResolverTest {
    ...
    fun `Constructs Java class with random constructor value`() {
        repeat(100) {
            assertIsRandom {
                (context.resolve(com.detomarco.kotlinfixture.FactoryMethodJavaClass::class) as com.detomarco.kotlinfixture.FactoryMethodJavaClass).constructor
            }
        }
    }
    ...
    fun `Constructs Java class with random setter value`() {
        repeat(100) {
            assertIsRandom {
                (context.resolve(com.detomarco.kotlinfixture.FactoryMethodJavaClass::class) as com.detomarco.kotlinfixture.FactoryMethodJavaClass).mutable
            }
        }
    }
    ...
    fun `Can override Java constructor arg`() {
        repeat(100) {
            val context = context.copy(
                configuration = ConfigurationBuilder().apply {
                    property<com.detomarco.kotlinfixture.FactoryMethodJavaClass, String>("arg0") { "custom" }
                }.build()
            )

            val result = context.resolve(com.detomarco.kotlinfixture.FactoryMethodJavaClass::class) as com.detomarco.kotlinfixture.FactoryMethodJavaClass
    ...
    fun `Can override Java setter`() {
        repeat(100) {
            val context = context.copy(
                configuration = ConfigurationBuilder().apply {
                    property<String>(com.detomarco.kotlinfixture.FactoryMethodJavaClass::setMutable) { "custom" }
                }.build()
            )
