...
class FixtureTest {
    ...
    fun `java constructor property can be set in fixture initialisation`() {
        val fixture = kotlinFixture {
            property<com.detomarco.kotlinfixture.FixtureTestJavaClass, String>("arg0") { "a" }
        }

        val instance = fixture<com.detomarco.kotlinfixture.FixtureTestJavaClass>()
    ...
    fun `java constructor property can be overridden in fixture creation`() {
        ...
        val instance = fixture<com.detomarco.kotlinfixture.FixtureTestJavaClass> {
            property<com.detomarco.kotlinfixture.FixtureTestJavaClass, String>("arg0") { "b" }
        }
    ...
    fun `java member property can be set in fixture initialisation`() {
        val fixture = kotlinFixture {
            property<String>(com.detomarco.kotlinfixture.FixtureTestJavaClass::setMutable) { "a" }
        }
    ...
    fun `java member property can be overridden in fixture creation`() {
        ...
        val instance = fixture<com.detomarco.kotlinfixture.FixtureTestJavaClass> {
            property<String>(com.detomarco.kotlinfixture.FixtureTestJavaClass::setMutable) { "b" }
        }
