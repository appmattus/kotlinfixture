...
import com.detomarco.kotlinfixture.decorator.nullability.NeverNullStrategy
import com.detomarco.kotlinfixture.decorator.nullability.nullabilityStrategy
...
class FixtureRepeatCountTest {
    ...
    fun `repeatCount can be overridden for java constructor property`() {
        val fixture = kotlinFixture {
            repeatCount { 2 }
            repeatCount<com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass>("arg0") { 1 }
        }

        val instance = fixture<com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass>()
    ...
    fun `java constructor property can be overridden in fixture creation`() {
        ...
        val instance = fixture<com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass> {
            repeatCount<com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass>("arg0") { 2 }
        }
    ...
    fun `repeatCount can be overridden for java member property`() {
        val fixture = kotlinFixture {
            repeatCount { 2 }
            repeatCount(com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass::setMutable) { 1 }
        }
    ...
    fun `java member property can be overridden in fixture creation`() {
        ...
        val instance = fixture<com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass> {
            repeatCount(com.detomarco.kotlinfixture.FixtureRepeatCountTestJavaClass::setMutable) { 2 }
        }
