 ...
 */
fun com.detomarco.kotlinfixture.config.Generator<String>.regexToRandom(regex: String, minLength: Int = 1, maxLength: Int = Int.MAX_VALUE): String {
 ...
 * IMPORTANT: Be careful with object creation inside the generation function as it will be called for every instance of the object you create.
 */
fun com.detomarco.kotlinfixture.config.Generator<String>.regexToRandom(regex: Regex, minLength: Int = 1, maxLength: Int = Int.MAX_VALUE): String {
